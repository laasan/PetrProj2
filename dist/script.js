...
var drop = function drop() {
  ...
  fileInput.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var nameArray = input.files[0].name.split('.');
      nameArray[0].length > 7 ? dots = '...' : dots = '.';
      var name = nameArray[0].substring(0, 7) + dots + nameArray[1];
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var nameArray = item.files[0].name.split('.');
      nameArray[0].length > 7 ? dots = '...' : dots = '.';
      var name = nameArray[0].substring(0, 7) + dots + nameArray[1];
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.parentNode.appendChild(statusMessage); // fadeout form

      item.classList.add('animated', 'fadeOutUp'); // stop display form at all
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    var img = block.querySelector('img'); // smth.png => smth-1.png
  ...
  function hideImg(block) {
    var img = block.querySelector('img'); // smth-1.png => smth.png
...
var scrolling = function scrolling(upSelector) {
  ...
  //              (to > from && scrollTop >= to) || (to < from && scrollTop <= to)) {
  //             clearInterval(move);
